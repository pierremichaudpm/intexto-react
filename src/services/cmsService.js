    ...
    return [
      {
        ...
        content:
          "Dans une annonce majeure, le gouvernement fédéral dévoile un nouveau programme de prestation canadienne pour l'épicerie. Cette mesure vise à aider les familles canadiennes à faire face à la hausse des coûts alimentaires. Le programme remplace l'exemption temporaire de TPS et offre un soutien financier direct aux ménages à revenu faible et moyen.",
      ...
      },
      {
        ...
        content:
          "La communauté haïtienne de Montréal pleure la perte de Dieudonné Larose. Les obsèques du célèbre artiste se sont tenues dans l'intimité familiale, respectant les dernières volontés du défunt. Larose laisse derrière lui un héritage musical inestimable qui a marqué plusieurs générations.",
        author: "Rédaction Intexto",
